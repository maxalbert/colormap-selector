...
- FEniCS (see installation instructions at [4]; if possible, it is highly
...
properties. It originated from a discussion [1] on the matplotlib
...
The most commonly used `RGB` color space [2] is not well suited for
...
`CIEL*a*b*` color space [3] which represents each color using three
...
[1] http://sourceforge.net/p/matplotlib/mailman/matplotlib-devel/?viewmonth=201411&viewday=21&style=threaded
[2] http://en.wikipedia.org/wiki/RGB_color_space
[3] http://en.wikipedia.org/wiki/Lab_color_space
[4] http://fenicsproject.org/download/


More info about colormaps and visualization
===========================================
